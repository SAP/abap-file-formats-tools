CLASS ltcl_json_writer DEFINITION FINAL FOR TESTING
  ...
  PRIVATE SECTION.
    ...
    METHODS: use_ddic_info_for_element FOR TESTING RAISING cx_static_check,
      ...
      time_element FOR TESTING RAISING cx_static_check,
      date_element FOR TESTING RAISING cx_static_check,
...
( ) ).
  ...
  METHOD date_time_element.
    DATA(act_schema) = test_generator->generate_type( VALUE utclong( ) ).
...
( ) ).
  ...
  METHOD time_element.
    DATA(act_schema) = test_generator->generate_type( VALUE t( ) ).
...
( ) ).
  ...
  METHOD nested_table_w_same_field_name.
    ...
    DATA(act_schema) = test_generator->generate_type( VALUE ty_main( ) ).
...
( `}` ) ).
  ...
  METHOD multiple_of_warning.
    DATA(act_schema_co) = test_generator->generate_type( VALUE zcl_aff_test_types=>structure_multiple_of_warning( ) ).
    DATA(exp_schema) = VALUE string_table(
                                         ( `{` )
                                         ( `  "$comment": "This file is autogenerated, do not edit manually, see https://github.com/SAP/abap-file-formats for more information.",` )
                                         ( `  "$schema": "https://json-schema.org/draft/2020-12/schema",` )
                                         ( `  "$id": "schema/id.json",` )
                                         ( `  "title": "Structure With Multiple Of Warning",` )
                                         ( `  "description": "This is a structure with not allowed multiple of value",` )
                                         ( `  "type": "object",` )
                                         ( `  "properties": {` )
                                         ( `    "integer": {` )
...
CLASS ltcl_json_writer_abap_doc DEFINITION FINAL FOR TESTING
  ...
  PRIVATE SECTION.
    ...
    spec_char_enum_ttle_desc_value FOR TESTING RAISING cx_static_check,
    type_without_title_and_desc FOR TESTING RAISING cx_static_check.
...
( ) ).
  ...
  METHOD content_encoded_integer.
    DATA(act_schema) = test_generator->generate_type( VALUE zcl_aff_test_types=>content_encoded_integer( ) ).
...
( ) ).
  ...
  METHOD content_encoding_unknown.
    DATA(act_schema) = test_generator->generate_type( VALUE zcl_aff_test_types=>unknown_content_encoded_string( ) ).
...
( ) ).
  ...
  METHOD content_encoding.
    DATA(act_schema) = test_generator->generate_type( VALUE zcl_aff_test_types=>content_encoded_string( ) ).
...
( ) ).
  ...
  METHOD content_media_type_string.
    DATA(act_schema) = test_generator->generate_type( VALUE zcl_aff_test_types=>content_media_type_string( ) ).
...
( ) ).
  ...
  METHOD content_media_type_integer.
    DATA(act_schema) = test_generator->generate_type( VALUE zcl_aff_test_types=>content_media_type_integer( ) ).
...
( ) ).
  ...
  METHOD encoding_type_next_level.
    DATA(act_schema) = test_generator->generate_type( VALUE zcl_aff_test_types=>struc_with_type_encoding( ) ).
...
( ) ).
  ...
  METHOD type_without_title_and_desc.
    test_generator->generate_type( VALUE zcl_aff_test_types=>type_without_title_and_desc( ) ).
    log = cut->zif_aff_writer~get_log( ).
    DATA(messages) = log->get_messages( ).
    IF NOT line_exists( messages[ message_text = 'Description is missing' ] ).
      cl_abap_unit_assert=>fail( msg = 'Expected log warning for missing description is not there' ).
    ENDIF.
    IF NOT line_exists( messages[ message_text = 'Title is missing' ] ).
      cl_abap_unit_assert=>fail( msg = 'Expected log warning for missing title is not there' ).
    ENDIF.
  ENDMETHOD.

  METHOD spec_char_enum_ttle_desc_value.
    DATA(act_schema_co) = test_generator->generate_type( VALUE zcl_aff_test_types=>quotat_mark_in_enum_abap_doc( ) ).
    DATA(exp_schema) = VALUE string_table(
( `{` )
( `  "$comment": "This file is autogenerated, do not edit manually, see https://github.com/SAP/abap-file-formats f` &&
`or more information.",` )
( `  "$schema": "https://json-schema.org/draft/2020-12/schema",` )
( `  "$id": "schema/id.json",` )
( `  "title": "Enum with quotation marks",` )
( `  "description": "Enum with quotation marks",` )
( `  "type": "object",` )
( `  "properties": {` )
( `    "specialCharEnum": {` )
( `      "title": "Enum With Special Characters",` )
...
( `      ],` )
( `      "enumTitles": [` )
( `        "Ampersand \" needs to be escaped in the enumTitles",` )
( `        "Quotation Marks"` )
( `      ],` )
( `      "enumDescriptions": [` )
...
( ) ).
  ...
  METHOD date_time_element.
    DATA(act_schema) = test_generator->generate_type( VALUE zcl_aff_test_types=>my_date_time( ) ).
    DATA(exp_schema) = VALUE string_table(
( `{` )
( |    "$comment": "This file is autogenerated, do not edit manually, see { zcl_aff_writer_json_schema=>c_link_to_repository } for more information.", | )
( |    "$schema": "{ zcl_aff_writer_json_schema=>c_schema_specification }",| )
( |    "$id": "{ schema_id }",| )
( `    "title": "Date-Time",` )
( `    "description": "This is a date-time",` )
( `    "type": "string",` )
( `    "format" :"date-time"` )
( `}` )
( ) ).
