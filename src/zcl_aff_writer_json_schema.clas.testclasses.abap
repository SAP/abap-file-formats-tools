...
( ) ).
  ...
  METHOD no_formatting.
    TYPES:
      ...
      END OF my_structure.
    cut->zif_aff_writer~set_formatting_option( zif_aff_writer=>formatting_option-no_formatting ).
...
( ) ).
  ...
  METHOD value_mapping.
    TYPES:
      ...
      END OF my_structure.
    cut->zif_aff_writer~set_abap_value_mappings( VALUE #(
      ( abap_element = 'MY_FIRST_ELEMENT' target_type = zif_aff_writer=>type_info-string
  ...
  METHOD name_mapping.
    TYPES:
      BEGIN OF my_structure,
        my_first_element TYPE string,
      END OF my_structure.
    cut->zif_aff_writer~set_name_mappings( VALUE #( ( abap = 'MY_FIRST_ELEMENT' json = 'elementFirst' ) ) ).
...
( ) ).
  ...
  METHOD enum_with_values_outside.
    DATA(act_schema_co) = test_generator->generate_type( VALUE zcl_aff_test_types=>header( ) ).
    DATA(exp_schema) = VALUE rswsourcet(
( ` { ` )
( |    "$comment": "This file is autogenerated, do not edit manually, see { zcl_aff_writer_json_schema=>c_link_to_repository } for more information.", | )
( |    "$schema": "{ zcl_aff_writer_json_schema=>c_schema_specification }",| )
...
( ) ).
  ...
  METHOD element_with_callbackclas.
    zcl_aff_test_types=>subschema = VALUE rswsourcet(
  ( `"title": "myStringName",` )
  ( `"description": "This is a String",` )
  ( `"type": "string",` )
  ( `"maxLength": 3` )
    ...
    DATA(act_schema) = test_generator->generate_type( VALUE zcl_aff_test_types=>string_callback( ) ).
    DATA(exp_schema) = VALUE rswsourcet(
( `{` )
( |    "$comment": "This file is autogenerated, do not edit manually, see { zcl_aff_writer_json_schema=>c_link_to_repository } for more information.", | )
( |    "$schema": "{ zcl_aff_writer_json_schema=>c_schema_specification }",| )
...
( ) ).
  ...
  ( `}` ) ).
    ...
    DATA(act_schema) = test_generator->generate_type( VALUE zcl_aff_test_types=>table_with_callback( ) ).
    DATA(exp_schema) = VALUE rswsourcet(
( `{` )
( |    "$comment": "This file is autogenerated, do not edit manually, see { zcl_aff_writer_json_schema=>c_link_to_repository } for more information.", | )
( |    "$schema": "{ zcl_aff_writer_json_schema=>c_schema_specification }",| )
...
( ) ).
  ...
  ( `}` )
    ...
    DATA(act_schema) = test_generator->generate_type( VALUE zcl_aff_test_types=>table_call_of_struc( ) ).
    DATA(exp_schema) = VALUE rswsourcet(
( `{` )
( |    "$comment": "This file is autogenerated, do not edit manually, see { zcl_aff_writer_json_schema=>c_link_to_repository } for more information.", | )
( |    "$schema": "{ zcl_aff_writer_json_schema=>c_schema_specification }",| )
