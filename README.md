...
* `z_generate_file_format_folder` generates files and folder hierachy for upload and maintain the [abap-file-formats](https://github.com/SAP/abap-file-formats) repository (requires abap file format framework)
